...
## RArm
for i, item in enumerate(actuador[2]):
    for j, item2 in enumerate(actuador[2][j]):
        actuador[2][i][j] = round((actuador[2][i][j] - actuador[4][i][j]), 2)
## RLeg
for i, item in enumerate(actuador[0]):
    for j, item2 in enumerate(actuador[0][j]):
        actuador[0][i][j] = round((actuador[0][i][j] - actuador[4][i][j]), 2)
## LLeg
for i, item in enumerate(actuador[1]):
    for j, item2 in enumerate(actuador[1][j]):
        actuador[1][i][j] = round((actuador[1][i][j] - actuador[4][i][j]), 2)
## LArm
for i, item in enumerate(actuador[3]):
    for j, item2 in enumerate(actuador[3][j]):
        actuador[3][i][j] = round((actuador[3][i][j] - actuador[4][i][j]), 2)
## TORSO
for i, item in enumerate(actuador[4]):
    for j, item2 in enumerate(actuador[4][j]):
        actuador[4][i][j] = round((actuador[4][i][j] - actuador[4][i][j]), 2)
## Head
for i, item in enumerate(actuador[5]):
    for j, item2 in enumerate(actuador[5][j]):
        actuador[5][i][j] = round((actuador[5][i][j] - actuador[5][i][j]), 2)
...
coordenadasCompletas = [actuador[2], actuador[0], actuador[1], actuador[3], actuador[4], actuador[5]]
