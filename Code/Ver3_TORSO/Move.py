...
#Inicializacion de parametros necesarios para el movimiento del NAO
    ...
    axisMask = [ motion.AXIS_MASK_VEL, motion.AXIS_MASK_VEL, motion.AXIS_MASK_VEL, motion.AXIS_MASK_VEL, motion.AXIS_MASK_VEL, motion.AXIS_MASK_VEL ] #Control de posicion XYZ
...
#Obtencion de la informacion del archivo CVS
    ...
    listaActuadores = ["RArm", "RLeg", "LLeg", "LArm", "Torso", "Head"] # sin piernas ni cabeza
